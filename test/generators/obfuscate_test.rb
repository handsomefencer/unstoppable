...
describe "Roro::CLI" do
  ...
  describe ":obfuscate(environment)" do
    ...
    Then { assert_file 'docker/containers/app/development.env.enc' }
    Then { assert_file 'docker/containers/web/development.env.enc' }
  end

  describe ":obfuscate" do

    Given { FileUtils.rm_rf('docker/keys/.') }

    Given { subject.generate_keys }
    Given { subject.obfuscate }
    Given { puts Dir.entries('docker/keys')}
