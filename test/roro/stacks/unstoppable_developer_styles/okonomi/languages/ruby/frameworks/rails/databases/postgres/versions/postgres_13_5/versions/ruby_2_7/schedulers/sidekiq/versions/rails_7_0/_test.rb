...
describe 'unstoppable_developer_styles: okonomi & languages: ruby & frameworks: rails & databases: postgres & versions: postgres_13_5 & versions: ruby_2_7 & schedulers: sidekiq & versions: rails_7_0' do
  Given(:workbench) {}
