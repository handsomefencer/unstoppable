...
def assert_configuration_mariadb
  ...
  assert_correct_okonomi_mariadb_base_env
  assert_correct_okonomi_mariadb_docker_compose
  assert_file('config/database.yml', /adapter: mysql2/)
  assert_file('Gemfile', /gem ["']mysql2["'], ["']~> 0.5/)
  assert_file('Dockerfile', /mysql-dev/)
end

def assert_correct_okonomi_mariadb_docker_compose
...
def assert_correct_okonomi_mariadb_base_env
  f = 'mise/env/base.env'
