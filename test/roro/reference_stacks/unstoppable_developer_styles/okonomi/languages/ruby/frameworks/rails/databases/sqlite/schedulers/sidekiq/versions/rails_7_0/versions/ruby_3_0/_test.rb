...
describe 'unstoppable_developer_styles: okonomi & languages: ruby & frameworks: rails & databases: sqlite & schedulers: sidekiq & versions: rails_7_0 & versions: ruby_3_0' do
  Given(:workbench) {}
