...
#         @configuration = Roro::Configuration.new
#         byebug
#         case 
#         when options["interactive" ]
#           set_from_interactive 
#         when Dir.glob('.roro.yml')
...
#           @master_config = YAML.load_file(File.dirname(__FILE__) + '../roro_configurator.yml')
      
#         # configurator = Roro::Configuration.new  
